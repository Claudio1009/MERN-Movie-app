...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 left-120 transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-16 mb-8 rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-8">
          ...
          >
            <MdOutlineLocalMovies className="mr-2 mt-12" size={26} />
          ...
          {!userInfo && (
            <ul className="flex">
              ...
              <li>
                <Link
                  to="/register"
                  className="flex items-center mt-5 transition-transform transform hover:translate-x-2 ml-4"
                >
